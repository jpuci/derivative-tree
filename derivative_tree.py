...
class BinaryTree:
    ...
    def _print_tree(self):
        """Helper function to the print method, returns a list of all nodes [left_child, node, right_child]."""
...
def build_parse_tree(fp_exp):
    ...
    fp_exp = re.sub(r'([a-z]{2,})', r'# \1', fp_exp)
...
def diff_parse_tree(e_tree):
    """Takes a BinaryTree and returns derivative of this tree. Compute derivatives of +, -, *, /, sin, cos, exp, log,
    **, (power must be float or int) and compound functions."""
    current_tree = e_tree
    current = e_tree.key
    new_tree = BinaryTree("")
